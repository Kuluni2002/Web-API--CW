...
// const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY4ZWJjY2M0NDAwZTBmZjM1NmI3YTNhMSIsImlhdCI6MTc2MDM4NjYyNSwiZXhwIjoxNzYyOTc4NjI1fQ.IIlXCXgljC2roZ4jr77AdPnAozdLYgohKUCBaoa9JQA'; // Replace with a valid operator token

// const SIMULATION_DURATION_MIN = 2; // Simulate each trip in 5 minutes
...
// function timeStringToMinutes(timeString) {
//   if (!timeString) return 0; // or throw an error if you want to catch bad data
//   const [h, m] = timeString.split(':').map(Number);
//   return h * 60 + m;
// }
...
// const scheduledStart = timeStringToMinutes(stops[0].scheduledArrival || stops[0].scheduledDeparture); // Use scheduledArrival or scheduledDeparture
